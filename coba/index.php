...
<head>
  ...
  <title>Electricity Payment Point</title>
  <!-- Bootstrap core CSS-->
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.php">Electricity Payment Point</a>
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Pelanggan">
          ...
          <ul class="sidenav-second-level collapse" id="collapseExamplePages">
            <li>
              <a href="index.php?page=tables">Data Pelanggan</a>
            </li>
            <li>
              <a href="index.php?page=form">Pelanggan Baru</a>
            </li>
          </ul>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Pembayaran">
          <a class="nav-link" href="index.php?page=tarif">
            <i class="fa fa-fw fa-money"></i>
            <span class="nav-link-text">Tarif Listrik</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Pembayaran">
    ...
    <footer class="sticky-footer">
      <div class="container">
        <div class="text-center">
          <small>Copyright © Xie Design 2018</small>
        </div>
      </div>
    </footer>
